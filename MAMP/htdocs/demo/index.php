...
$ch = curl_init();
$header = array();
$header[] = 'Authorization: Bearer X6Y2TIHDOO5XDEZ2QTJMZYCGOHXJC2TY';
...
$certificate = "C:\2022_WINTER_PROJECT\MAMP\bin\php\php7.4.1\cacert.pem";
...
for ($i = 0; $i < count($server_decoded_rsp); $i++){
	...
	$con_db = mysqli_connect("localhost:3306", "root", "root", "hw2_witAI"); 
